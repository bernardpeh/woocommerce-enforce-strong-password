=== Plugin Name ===
Contributors: bpeh
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=bpeh_cart@sitecritic.net&item_name=wordpress+plugin+donation
...
Allows woocommerce administrator enforce strong password usage.
...
If you find this plugin useful, consider [donating](https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=bpeh_cart@sitecritic.net&item_name=wordpress+plugin+donation) 

Visit my [web development blog](http://www.azhowto.com) for more information.
...
In the search field type "WooCommerce enforce strong password" and click Search Plugins. Click _Install Now_.
...
1. The plugin settings on the woocommerce -> settings -> settings page.
